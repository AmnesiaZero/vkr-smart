            ...
            <div class="row py-5 g-4">
                    ...
                    <div class="card br-none shadow-1 br-15 p-4 h-100">
                        ...
                        <div class="card-body brt-green-light-1 p-0 pt-3">
                            <p class="fs-14 lh-18 ellipsis-8">Выражаю благодарность разработчикам системы хранения работ
                                учебного заведения и проверок на объем заимствований ВКР-СМАРТ.РФ. Мы используем эту
                                ...
                                функционалом, другие очень дороги. А ВКР-СМАРТ.РФ максимально устроила нас оптимальным
                                ...
                                системы мы смогли значительно упростить контроль за ВКР. Система ВКР-СМАРТ.РФ полностью
                ...
                <div class="col-lg-4">
                    <div class="card br-none shadow-1 br-15 p-4 h-100">
                        ...
                        <div class="card-body brt-green-light-1 p-0 pt-3">
                            <p class="fs-14 lh-18 ellipsis-8">Работу нашего института с платформой ВКР-СМАРТ.РФ можно
                                ...
                                программного обеспечения? ВКР-СМАРТ.РФ дает ответы на все вопросы. Благодаря простоте
                                ...
                                в ЭБС и их проверке на заимствования. Словом, подключение к платформе ВКР-СМАРТ.РФ
                    ...
                    <div class="card br-none shadow-1 br-15 p-4 h-100">
                        ...
                        <div class="card-body brt-green-light-1 p-0 pt-3">
                            <p class="fs-14 lh-18 ellipsis-8">В целях выполнения приказа Министерства образования и
                                ...
                                платформ решили приобрести ВКР-СМАРТ.РФ. Этот ресурс очень удобен в использовании, с
                                ...
                                квалификационных работ в базе. Если говорить коротко, то ВКР-СМАРТ.РФ можно
                ...
                <div class="row g-4">
                    ...
                    <div class="col-xxl-7 col-lg-6 col-sm-8 col-12">
                        <p class="lh-18 fs-12">Программа для ЭВМ «ВКР -СМАРТ» — «умная» система проверки на
                            ...
                            № 2 021 664 219</p>
                        <p class="lh-18 fs-12 m-0">ООО «PROFобразование» включено в Реестр аккредитованных IT компаний,
