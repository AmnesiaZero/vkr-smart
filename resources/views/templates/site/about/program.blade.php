        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-9 px-lg-0 px-4">
                    <div class="block-75">
                        <p class="text-black-black">Система ВКР-СМАРТ.РФ — модульный программный комплекс, который
                            состоит
                            из:</p>
                        ...
                        <p class="fs-14 lh-17">Для своих решений мы используем только качественные и самые современные
                            технологии, мощные и надежные серверы, — все это обеспечивает бесперебойность
                            работы
                        ...
                        <div class="bg-black p-4 br-20 my-5">
                            <div class="row">
                                <div class="col-7">
                                    <h6 class="text-white fs-16">Система ВКР-СМАРТ <br>зарегистрирована как программа
                                        для
                                        ЭВМ
                                    </h6>
                                    <p class="text-white">«ВКР-СМАРТ» — «умная» система проверки на заимствования и
                                        хранения ВКР, зарегистрирована в Федеральной службе по интеллектуальной
                                        собственности 01 сентября 2021 года,
                                        Свидетельство о государственной регистрации программы для ЭВМ рег. №
                                        2021664219</p>
                                </div>
                        ...
                        <p class="fs-14 lh-17">Так как многие работы учебных заведений сегодня содержат эксклюзивные
                            ...
                            компания
                            «PROFобразование» дает своим клиентам гарантии охраны текстов от доступа третьих лиц. Это
                            важное
