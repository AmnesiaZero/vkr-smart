        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-9 px-lg-0 px-4">
                    <div class="block-75">
                        <p class="text-black-black mb-5">Для работы в системе ВКР-СМАРТ.РФ <br>предусмотрено четыре типа
                            пользователей:</p>
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <ul class="text-black fs-14">
                                            ...
                                            <li>проверяют на заимствования по базе ВКР всех партнеров платформы
                                                ВКР-СМАРТ.РФ без доступа к каким-либо текстам и по базе всех изданий ЭБС
                                                IPRbooks;
                                            </li>
                                    ...
                                    <div class="accordion-body">
                                        <ul class="text-black fs-14">
                                            <li>загрузка и проверка на объем заимствований своих работ для их
                                                ...
                                                учебного заведения на платформе ВКР-СМАРТ.РФ;
                                            </li>
