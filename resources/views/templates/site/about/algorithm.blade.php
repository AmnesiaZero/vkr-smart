        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-9 px-lg-0 px-4">
                    <div class="block-75">
                        <p class="fs-14 lh-17">Для работы в системе ВКР-СМАРТ.РФ необходимо авторизоваться под учетными
                        ...
                        <p class="fs-14 lh-17">Указанные учетные данные предназначены для администратора платформы
                            ВКР-СМАРТ.РФ*, лица, ответственного за размещение ВКР и электронных портфолио в целом по
