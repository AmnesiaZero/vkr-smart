        ...
        <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
            <div class="br-green-light-1 p-3 br-15">
                <div class="d-flex pb-4">
                    ...
                    <p class="text-grey fs-14 m-0 px-3 d-flex align-items-center">
                        <img src="/images/green_active.svg" alt="" class="pe-2">
                        Активен
                    </p>
                    </div>
                    @{{else}}
                    ...
                    <p class="text-grey fs-14 m-0 px-3 d-flex align-items-center">
                        <img src="/images/red.svg" alt="" class="pe-2">
                        Заблокирован
                    </p>
                    </div>
                    @{{/if}}
                ...
                <p class="mt-3">
                    ...
                    <a href="#" class="text-grey ps-2 fs-14 link-active-hover" onclick="openWorks(${id})">Работы</a>
                </p>
                <p class="mt-2"><img src="/images/User_Card_Id_Grey.svg" alt=""><a href="/dashboard/portfolio/${id}"
                                                                                   class="text-grey ps-2 fs-14 link-active-hover">Портфолио</a>
                </p>
                <p class="mb-2 mb-3"><img src="/images/setting_grey.svg" alt="">
                    <a href="/dashboard/portfolio/achievements/${id}" class="text-grey ps-2 fs-14 link-active-hover">
