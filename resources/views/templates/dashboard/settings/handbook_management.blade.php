    ...
    <div class="col-xl-9 col-lg-8 col-md-7 col-12">
        <div class="row px-0 px-sm-4 mx-sm-0 mx-4 pt-4">
            <div class="col-xl-6 col-lg-8 col-md-10 col-12">
                <div class="br-green-light-2 br-15 p-3 mb-2">
                    <form onsubmit="addWorksType();return false" id="add_works_type_form" class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" name="name" id="content" class="form-control" placeholder="Наименование"
                                   onkeydown="checkForEnter(event)" required>
                    ...
                    <form onsubmit="addScientificAdvisor();return false" id="add_scientific_advisor_form" class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" name="name" id="content_1" class="form-control" placeholder="ФИО"
                                   onkeydown="checkForEnter_1(event)" required>
                            <button type="submit" class="fs-14 btn text-grey btn-secondary">Добавить</button>
                        </div>
                    </form>
                </div>
...
@section('scripts')
    ...
    <script id="scientific_supervisor_tmpl" type="text/x-jquery-tmpl">
       <div class="badge text-black-black bg-green-light br-100 fs-14 me-1 mb-1" onclick="deleteScientificSupervisor(${id})" id="scientific_supervisor_${id}">
       ${name}
    ...
    <script id="works_type_tmpl" type="text/x-jquery-tmpl">
       <div class="badge text-black-black bg-green-light br-100 fs-14 me-1 mb-1" onclick="deleteWorkType(${id})" id="work_type_${id}">
       ${name}
        <i class="fa fa-times ms-2 cursor-p text-black fs-12" onclick="deleteWorkType(${id})"></i>
       </div>
    </script>
