...
<div class="container">
    ...
    <h2 class="bc-post-title-xs">Отметьте те подразделения, по которым вы бы хотели получать информацию и нажмите
        «Сохранить»</h2>
    <div class="row">
        <div class="col-sm-12">
                                ...
                                @foreach($faculty->departments as $department)
                                    <div class="row row-bb">
                                        <div class="checkbox col-sm-12">
                                            <label class="text-success"><input type="checkbox"
                                                                               value="{{$department->id}}"
                                                                               name="departments_ids[]"
                                                                               @if(in_array($department->id,$departments_ids)) checked @endif> {{$faculty->name}}
