...
@section('content')
    <div class="list">
        ...
        <form id="organization_form" enctype="multipart/form-data" action="{{ route('organizations.create') }}"
              method="POST">
            @csrf
            <div class="row">
                <div class="col-8">
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input id="logo" type="text"
                                       value="@if(isset($organization) and $organization->logo_file_name) {{$organization->logo_file_name}} @endif"
                                       class="form-control"
                ...
                <div class="col-4">
                    ...
                    <div class="form-group">
                        ...
                        <small id="emailHelp" class="form-text text-muted">Укажите дату в формате
                            <strong>yyyy/mm/dd</strong></small>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            <label for="is_head" class="custom-control-label"
                                   style="font-size: 14px; font-weight: normal">Головная организация</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <input id="is_basic" type="checkbox" name="is_basic" value="1" class="custom-control-input">
                            <label for="is_basic" class="custom-control-label"
                                   style="font-size: 14px; font-weight: normal">Базовый доступ</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            <label for="is_premium" class="custom-control-label"
                                   style="font-size: 14px; font-weight: normal">Доступ Premium (все издания
                                доступны)</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <input id="is_testing" type="checkbox" name="is_testing" value="1"
                                   class="custom-control-input">
                            <label for="is_testing" class="custom-control-label"
                                   style="font-size: 14px; font-weight: normal">Тестовый доступ</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <input id="is_demo" type="checkbox" name="is_demo" value="1" class="custom-control-input">
                            <label for="is_demo" class="custom-control-label"
                                   style="font-size: 14px; font-weight: normal">Демо-организация (для презентаций и
                                технических работ)</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <input id="member_transfer_network" type="checkbox" name="member_transfer_network" value="1"
                                   class="custom-control-input">
                            <label for="member_transfer_network" class="custom-control-label"
                                   style="font-size: 14px; font-weight: normal">Участник сети трансферов</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            <input id="show_catalog" type="checkbox" name="show_catalog" value="1"
                                   class="custom-control-input">
                            <label for="show_catalog" class="custom-control-label"
                                   style="font-size: 14px; font-weight: normal">Отображать в каталоге</label>
                        </div>
                    </div>
                    <h3 class="mb-3">Структура организации</h3>
                    <div class="d-flex justify-content-between">
                        <button type="button" data-toggle="modal" data-target="#modalDepartments" class="btn btn-info"
                                style="width: 48%;"><i class="fas fa-network-wired"></i> Отделения
                        </button>
                        <button type="button" class="btn btn-info" style="width: 48%;"><i class="fas fa-users"></i>
                            Группы
                        </button>
                    </div>
