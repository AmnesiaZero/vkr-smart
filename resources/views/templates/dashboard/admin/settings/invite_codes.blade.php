                    ...
                    <div class="d-flex inline-flex justify-content-between mb-3 align-items-center" id="students_list_head">
                        ...
                        <a href="#" onclick="downloadStudentsCodes()"
                           class="badge bg-green br-100 text-grey fs-14 cursor-p px-3 py-2 text-decoration-none">
                            Выгрузить
                            <img src="/images/File_Download.svg" alt="" class="ps-1">
                        </a>
                    </div>
...
@section('scripts')
    ...
    <script id="invite_code_tmpl" type="text/x-jquery-tmpl">
     <div class="border-bottom mb-2">
        <div class="input-group mb-0 br-none d-flex justify-content-center" style="width: 100%;">
            <input type="text" class="form-control form-copy br-none text-black ps-0 content"
                   value="${id}-${code}" aria-describedby="button-addon2" size="10" readonly>
            <button class="copy btn copy_btn br-none" type="button" onclick="copyInviteCode()"></button>
        </div>
