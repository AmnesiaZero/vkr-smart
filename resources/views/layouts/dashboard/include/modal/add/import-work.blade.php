                ...
                <div class="modal-body">
                    <div class="d-flex flex-column gap-3">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select name="year_id" class="selectpicker form-control w-100" id="import_years_list"
                                        data-width="100%"
                                        title="Выбрать...">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select name="faculty_id" class="selectpicker form-control w-100"
                                        id="import_faculties_list" data-width="100%"
                                        title="Выбрать...">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select name="department_id" class="selectpicker w-100 form-control"
                                        id="import_departments_list" data-width="100%"
                                        title="Выбрать...">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select name="specialty_id" class="selectpicker w-100 form-control"
                                        id="import_specialties_list" data-width="100%"
                                        title="Выбрать...">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <div class="radio">
                                    <label>
                                        <input type="radio" name="verification_method" value="0"> Проверить
                                        автоматически после загрузки
                                    </label>
                                </div>
                                <div class="radio mt-2">
                                    <label>
                                        <input type="radio" name="verification_method" value="1" checked=""> Проверять
                                        работы в ручном режиме
                                    </label>
                                </div>
                                <div class="radio mt-2">
                                    <label>
                                        <input type="radio" name="verification_method" value="2"> Не проверять работы
                                        после загрузки
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <p>Если Вы загружаете CSV файл, в этом случае он должен иметь в качестве разделителей «;», а
                            также значения полей должны быть обрамлены в «"»</p>
                        <p class="text-right"><a href="/assets/templates/c/xlss/template.xls"
                                                 class="btn btn-link btn-lg">Скачать образец заполнения списков
                                работ</a></p>
                    </div>
