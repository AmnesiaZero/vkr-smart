    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_achievement_form" onsubmit="addAchivement(); return false;" class="form-inline">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="record_date" class="form-control datepick" required="">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <button type="submit" class="btn btn-success">Добавить достижение</button>
                        </div>
                    </div>
                </form>
            </div>
